    ...
    >
      ...
      >
        <div className="project-immersive-content">
          ...
          {/* =================================================================== */}
          {/* CHAPTER 12 — PROTOTYPE (External Prototype Launch) */}
          {/* =================================================================== */}
          <section className="project-chapter chapter-prototype">
            ...
            <div className="prototype-launch-card">
              <div className="prototype-launch-glow" aria-hidden="true" />
              <div className="prototype-launch-content">
                <span className="prototype-badge">FIGMA PROTOTYPE</span>
                <h2 className="prototype-headline">EXPERIENCE THE FINAL PRODUCT</h2>
                <p className="prototype-lead">
                  Explore the full interactive Scotiabank Scene+ prototype in high fidelity. Navigate through the complete banking experience, onboarding journey, transit route rewards, and partner redemption maps.
                </p>
                ...
                <div className="prototype-actions">
                  <a
                    ...
                    className="prototype-launch-btn"
                    aria-label="Open Scotiabank Scene+ Figma prototype in a new tab"
                  >
                    <span>OPEN PROTOTYPE IN NEW WINDOW</span>
